  ...
  return (
    <Typist startDelay={500} avgTypingDelay={35} stdTypingDelay={30} cursor={{ show: false }}>
      <p className="text-xl text-white text-opacity-90">
        ...
        <span className="text-blue-300">@adityasingh/latest</span>)
      </p>
    </Typist>
  );
}
...
function Socials() {
  return (
    <motion.div
      ...
      transition={{ delay: 4 }}
    >
      <Link label="Email" link="aditya0930singh@gmail.com" />
  ...
  return (
    ...
    >
      <p className="flex flex-row items-center justify-start space-x-1 text-xl text-white text-opacity-90">
        <span className="text-blue-300">aditya@ubuntu</span>:~$ Hit F11 to enter full screen. Press
        any key to continue...
