...
export default function Mobile(props) {
  ...
  return (
    <div className="fixed z-50 flex md:hidden flex-col items-center justify-between inset-0 bg-black pb-10 overflow-hidden">
      <div className="flex md:hidden flex-col items-start justify-start w-[90%] py-5 space-y-8">
        <div className="flex flex-col items-start justify-start w-full space-y-4">
          <div className="flex flex-row items-center justify-between w-full">
            <p className="text-xl text-white text-opacity-70">Aditya Singh</p>
            <i
